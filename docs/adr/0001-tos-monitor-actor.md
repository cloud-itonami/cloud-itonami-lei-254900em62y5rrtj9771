...
- Related: [`com-junkawasaki/root` ADR-2607110300](https://github.com/com-junkawasaki/root/blob/main/90-docs/adr/2607110300-cloud-itonami-lei-corporate-tos-catalog.edn)
  ...
  (the fifth 10-repo validation batch this repo is part of).

## Context

This repository archives the publicly published Conditions for Use of
SBS Transit Ltd, per ADR-2607110300 -- a read-only reference archive. As
part of a fifth 10-repo validation batch extending the
`cloud-itonami-lei-2572ibtt8cczw6au4141` pilot (see ADR-2607241900/
ADR-2607242600 for the full fleet-level design rationale), this repo gains
...
- **Company**: SBS Transit Ltd, LEI 254900EM62Y5RRTJ9771, website
  `https://www.sbstransit.com.sg`. **First Singapore-jurisdiction company in
  this actor family.**
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url
  `https://www.sbstransit.com.sg/conditions-for-use`, retrieved-at
  `2026-07-19T08:43:15Z`, doc-type `:terms-of-service`.
...
proves the actor pattern holds for the first Singapore-jurisdiction
company in this fleet, and for a public-transit-operator domain shape.
