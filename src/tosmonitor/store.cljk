(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (SBS Transit Ltd, LEI
  254900EM62Y5RRTJ9771) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Conditions for Use\nThese Conditions for Use govern your access to and use of this website, which is operated by SBS Transit Ltd, a public transport operator providing bus and rail services in Singapore. By using this site you agree to comply with these Conditions, which are governed by and construed in accordance with the laws of the Republic of Singapore, and you submit to the non-exclusive jurisdiction of the Singapore courts.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.sbstransit.com.sg/conditions-for-use"
   :retrieved-at "2026-07-19T08:43:15Z"
